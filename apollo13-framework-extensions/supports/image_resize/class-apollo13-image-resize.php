...
if( class_exists('A13IR_Image_Editor_Imagick') ){
    ...
    function a13fe_ir_wp_image_editor_check_notice() {
        printf( "<div class='error'><p>%s</div>", 'Error 1001 - '.'<a href="'.esc_url( admin_url( 'site-health.php') ).'">'.esc_html__( 'Your Server is missing any image library to resize images. Please check the Site health for more details.', 'apollo13-framework-extensions').'</a>' );
    }
